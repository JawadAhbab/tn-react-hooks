...
type El = HTMLElement
type Props<E extends El> = { entry: IntersectionObserverEntry; elm: E }
...
export function useIntersectionObserver<E extends El = El>(observe: Observe<E>): R<E>
export function useIntersectionObserver<E extends El = El>($elm: ERef<E>, observe: Observe<E>): R<E>
export function useIntersectionObserver<E extends El = El>(...args: Args<E>): R<E> {
